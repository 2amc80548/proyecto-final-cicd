...
class WebapiApplicationTests {
	...
	@Test
	void checkCalculatorAddResponse() throws Exception {
		MockMvc.perform(get("/api/calculator/add?a=10&b=5"))
			.andExpect(status().isOk());
	}

	@Test
	void checkCalculatorDivideByZeroResponse() throws Exception {
